...
class KITTI(ImageDataset):
    CAM_INTRINSIC = {
        '2011_09_26' : torch.tensor([[7.215377e+02, 0.000000e+00, 6.095593e+02, 4.485728e+01], 
                        [0.000000e+00, 7.215377e+02, 1.728540e+02, 2.163791e-01],
                        [0.000000e+00, 0.000000e+00, 1.000000e+00, 2.745884e-03]]),
        '2011_09_28' : torch.tensor([[7.070493e+02, 0.000000e+00, 6.040814e+02, 4.575831e+01], 
                        [0.000000e+00, 7.070493e+02, 1.805066e+02, -3.454157e-01], 
                        [0.000000e+00, 0.000000e+00, 1.000000e+00, 4.981016e-03]]),
        '2011_09_29' : torch.tensor([[7.183351e+02, 0.000000e+00, 6.003891e+02, 4.450382e+01], 
                        [0.000000e+00, 7.183351e+02, 1.815122e+02, -5.951107e-01],
                        [0.000000e+00, 0.000000e+00, 1.000000e+00, 2.616315e-03]]),
        '2011_09_30' : torch.tensor([[7.070912e+02, 0.000000e+00, 6.018873e+02, 4.688783e+01], 
                        [0.000000e+00, 7.070912e+02, 1.831104e+02, 1.178601e-01], 
                        [0.000000e+00, 0.000000e+00, 1.000000e+00, 6.203223e-03]]),
        '2011_10_03' : torch.tensor([[7.188560e+02, 0.000000e+00, 6.071928e+02, 4.538225e+01], 
    ...
    def eval_mask(self, valid_mask, info={}):
        ...
        if "garg" in self.crop:
            eval_mask[..., int(0.40810811 * mask_height):int(0.99189189 * mask_height), int(0.03594771 * mask_width):int(0.96405229 * mask_width)] = 1
        elif "eigen" in self.crop:
            eval_mask[..., int(0.3324324 * mask_height):int(0.91351351 * mask_height), int(0.03594771 * mask_width):int(0.96405229 * mask_width)] = 1
...
class KITTIBenchmark(ImageDataset):
    ...
    def load_dataset(self):
        h5file = h5py.File(os.path.join(self.data_root, self.hdf5_path), 'r', libver='latest', swmr=True)        
        ...
        for line in txt_string.split("\n"):
            ...
            intrinsics = torch.tensor(intrinsics[os.path.join(*image_filename.split("/")[:2])]).squeeze()[:, :3]
            sample = {
